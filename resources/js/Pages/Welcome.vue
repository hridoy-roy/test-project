        ...
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            ...
            <template v-else>
                <Link
                    ...
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-red-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                    >Admin Log in</Link
                >

                <Link
                    :href="route('admin.register')"
                    class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-red-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                >Admin Register</Link>
